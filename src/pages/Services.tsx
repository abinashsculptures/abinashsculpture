...
const Services: React.FC = () => {
  ...
  const services = [{
    ...
    details: ["Initial consultation and concept development", "Sketches and digital mockups", "Material selection guidance", "Regular progress updates", "Professional installation available"],
    ...
    details: ["Traditional and contemporary designs", "Multiple sizes available", "Variety of materials including stone, bronze, and marble", "Customized bases and pedestals", "Consecration assistance available"],
    ...
    details: ["Multiple meditation poses available", "Traditional and modern interpretations", "Indoor and outdoor options", "Specialty finishes and patinas", "Custom sizing available"],
    ...
    details: ["Architectural consultation and planning", "Traditional stone selection", "Hand-carved details and ornamentation", "On-site installation and assembly", "Restoration of existing temple structures"],
        ...
        <section className="section-padding">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 gap-16">
              {services.map((service, index) => <div key={service.title} className={`grid grid-cols-1 md:grid-cols-2 gap-8 items-center ${index % 2 === 1 ? 'md:flex-row-reverse' : ''}`}>
                  <div className={index % 2 === 1 ? 'order-1 md:order-2' : ''}>
                    ...
                    <div className="mb-6">
                      ...
                      <ul className="space-y-2">
                        {service.details.map((detail, i) => <li key={i} className="flex items-start">
                  ...
                  <div className={`h-64 md:h-80 rounded-lg overflow-hidden ${index % 2 === 1 ? 'order-2 md:order-1' : ''}`}>
                    <img src={service.image} alt={service.title} className="w-full h-full object-center object-contain" />
                  </div>
                </div>)}
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-white p-4 rounded-lg text-center hover-scale">
                <img alt="Hindu Gods" src="https://i.postimg.cc/x84jzpDk/Annapoorani.jpg" className="w-full h-48 rounded-lg mb-4 object-fill" />
                <h3 className="font-medium">Hindu Gods</h3>
              </div>
              <div className="bg-white p-4 rounded-lg text-center hover-scale">
                <img src="/lovable-uploads/966a3bb0-7519-4427-a96f-50d82f1d3f73.png" alt="Buddhas" className="w-full h-48 rounded-lg mb-4 object-fill" />
